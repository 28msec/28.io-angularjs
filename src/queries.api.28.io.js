...
.factory('Queries', function($q, $http, $rootScope){
    ...
    return function(domain) {
         ...
         * @param {string} output-collection - The output collection when runnng the query asynchronously., 
        ...
        this.executeQuery = function(parameters){
            ...
            var url = domain + path;
            var params = {};
                params['async'] = parameters.async;
            params['output-collection'] = parameters.outputCollection;
            params['trace'] = parameters.trace;
            params['token'] = parameters.token;
            var cached = parameters.$cache && parameters.$cache.get(url);
